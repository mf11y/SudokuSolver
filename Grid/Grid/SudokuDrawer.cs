...
namespace Sudoku
{
    class SudokuDrawer
    {
        ...
        public SudokuDrawer(ref Board b)
        {
            board = b;
        }
        ...
        public void DrawInBox(Graphics e,string write, Point boxCoords)
        {
            //lock (e)
            {
                e.DrawString(write, myFont, Brushes.Black, GetMiddleOfBox(boxCoords));
            }
        }
